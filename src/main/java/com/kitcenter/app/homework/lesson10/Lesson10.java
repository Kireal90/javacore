...
public class Lesson10 {
    ...
    public static void readWriteFile()
        ...
        System.out.println("HometaskLesson10Runner");
...
//        Scanner propInput = new Scanner(System.in);
//
...
//            String valUser = propInput.nextLine();
//            strArray = valUser.split(",");
//            key = strArray[0];
//            value = strArray[1];
//            prop.setProperty(key, value);
//
////                prop.store(output, null);
//            if (valUser.equalsIgnoreCase(" ")) {
//                isOn = false;
//                break;
//            }
//        }
...
//
//
//        System.out.println(prop.getProperty("qq"));
//
//    }
}
